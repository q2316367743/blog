...
(function() {
    ...
    let cfg_dev = {
            ...
            web_url: 'http://localhost:8990/resource/' // 此项目前台地址 (此配置项非必须)
        }
        // 服务器测试环境
    let cfg_prod = {
        api_url: './api/',
...
(function() {
    ...
    sa.getJSON = function(url, success, error) {
        instance({
            url: url,
            method: 'GET'
        }).then(res => {
    ...
    sa.get = function(url, data, success, error) {
        instance({
            url: url,
            method: 'GET',
            params: data
    ...
    sa.post = function(url, data, success, error) {
        instance({
            url: url,
            method: 'POST',
            data: data
    ...
    sa.put = function(url, data, success, error) {
        instance({
            url: url,
            method: 'PUT',
            data: data
