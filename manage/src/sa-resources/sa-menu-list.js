...
export default [{
    ...
    },
    {
        ...
        childList: [{
            ...
            name: '轮播图设置',
            view: () =>
                import ('@/sa-view/home/swiper-list.vue')
        }]
    },
    {
        id: '4',
        ...
        childList: [{
                ...
                name: '角色列表',
                view: () =>
                    import ('@/sa-view/role/role-list.vue')
            },
            {
                id: '4-2',
                name: '菜单预览',
                view: () =>
                    import ('@/sa-view/role/menu-list.vue')
            }
        ]
    },
    {
        ...
        childList: [{
                ...
                name: '用户列表',
                view: () =>
                    import ('@/sa-view/user/user-list.vue')
            },
            {
                id: '5-1',
                name: '用户添加',
                view: () =>
                    import ('@/sa-view/user/user-add.vue'),
                params: { username: '王铁汉' }
            },
        ],
    ...
    },
    {
        ...
        childList: [{
            ...
            name: '文章列表',
            view: () =>
                import ('@/sa-view/article/art-list.vue')
        }, ]
    },
    //  ========= 示例 指定一个函数, 点击菜单时执行这个函数 ================
    {
        ...
        childList: [{
                id: '7-1',
                name: '登录页',
                click: function(sa_admin, sa) { // 点击这个菜单时将执行这个函数 
            ...
            },
            {
                ...
                name: '服务器设置',
                view: () =>
                    import ('@/sa-view/cfg/system-cfg.vue')
            },
        ]
    },
    //  ========= 示例 外部链接 点击从新窗口打开 ================
